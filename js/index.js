...
function main() {
  ...
  const shaderProgram = initializeShaderProgram(gl, vShader, fShader);
...
function initializeShaderProgram(gl, vShader, fShader) {
...
function loadShader(gl, type, source) {
  ...
  if (!gl.getShaderParameter(shader, gl.COMPILE_STATUS)) {
    alert('Error en shaders: ' + gl.getShaderInfoLog(shader));
...
function drawScene(gl, programInfo, buffers) {
  ...
  mat4.translate(modelMatrix,     // destination matrix
                 ...
                 [-1, 1.0, -1.0]);  // amount to translate

   mat4.translate(viewMatrix,     // destination matrix
                 viewMatrix,     // matrix to translate
                 [-1, 3, 2]);  // amount to translate
